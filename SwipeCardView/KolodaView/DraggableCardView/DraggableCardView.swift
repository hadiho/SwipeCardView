        ...
        if scrollIsAvailable {
            ...
            case .began:
                ...
                dragBegin = true
                 ...
                 if delegate?.isRotatePointEnabled() == false {
            ...
            case .changed:
                ...
                if delegate?.isHorizantalDragEnabled() == true {
                    dragDistance.y = 0
                }
                ...
                if delegate?.isScaleDragDownEnabled() == true {
...
//    }
    ...
    private func updateOverlayWithFinishPercent(_ percent: CGFloat, direction: SwipeResultDirection?) {
        ...
        // MARk : Remove original overlay
//        overlayView?.update(progress: progress)
        overlayDelegate?.overlay(progress, direction)
    }
    ...
    private func resetViewPositionAndTransformations() {
        ...
        self.overlayDelegate?.overlay(0,nil)
