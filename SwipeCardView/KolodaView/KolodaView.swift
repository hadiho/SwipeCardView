...
open class KolodaView: UIView, DraggableCardDelegate {
    ...
    func isHorizantalDragEnabled() -> Bool {
        return isHorizontalDragEnabled
    }
    
    func isScaleDragDownEnabled() -> Bool {
        return isScaleDownEnabled
    }
    
    func isRotatePointEnabled() -> Bool {
        return isRotatePointEbabled
    }
    //Opacity values
    ...
    public var scrollIsAvailable = true
    public var isHorizontalDragEnabled = true
    public var isRotatePointEbabled = true
    public var isScaleDownEnabled = true
    ...
    var currentCard:DraggableCardView?
